...
(function($) {
    ...
    $.jqplot.DonutRenderer.prototype.draw = function (ctx, gd, options, plot) {
        ...
        if (this.totalLabel) {
			...
			if(this.valorCentro.length == 2){
				this.valorCentro = '&nbsp;'+ this.valorCentro;
			}else if(this.valorCentro.length == 1){
				this.valorCentro = '&nbsp;'+ '&nbsp;' + this.valorCentro;
			}
			
            var totalLabel = $('<div class="jqplot-data-label" style="position:absolute"><div style="'+ this.estilo + '">' + this.valorCentro + '%</div></div>').insertAfter(plot.eventCanvas._elem);
