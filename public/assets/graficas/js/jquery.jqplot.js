            ...
            for (index=0, l=this.series.length; index<l; index++) {
                ...
                if (this.stackSeries && !series.disableStack) {
                    ...
                    for (var k=0, cdl=cd.length; k<cdl; k++) {
                        ...
                        this._plotData[index][k][sidx] = temp+parametro;
                        ...
                        if (index > 0) {
                            for (var j=index; j--;) {
                                ...
                                if (temp * prevval == 0){ //Icfes: se realiza una validacion
                                    ...
                                    this._plotData[index][k][sidx] += prevval+parametro;
									sumaTotal+=parametro;
                                    this._stackData[index][k][sidx] += prevval;
                                    break;
                                }    
