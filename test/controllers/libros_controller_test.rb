...
class LibrosControllerTest < ActionController::TestCase
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post :create, libro: { categoria: @libro.categoria, formato: @libro.formato, nombre: @libro.nombre, precio: @libro.precio }
    end
  ...
  test "should update libro" do
    patch :update, id: @libro, libro: { categoria: @libro.categoria, formato: @libro.formato, nombre: @libro.nombre, precio: @libro.precio }
    assert_redirected_to libro_path(assigns(:libro))
  end
